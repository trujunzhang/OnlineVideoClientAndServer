...
Pod::Spec.new do |s|
  ...
  s.subspec 'NSArray-SortedOrderIndices' do |sub|
    sub.source_files = 'Pod/Classes/NSArray-SortedOrderIndices/*.{h,m}'
  end

  s.subspec 'NSString-URLEncode' do |sub|
    sub.source_files = 'Pod/Classes/NSString-URLEncode/*.{h,m}'
  end
