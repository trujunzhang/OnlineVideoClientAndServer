...
@implementation ArraySRTParserHelper {

}
- (void)parseSRTString123:(NSString *)string toDictionary:(NSMutableDictionary *)subtitlesParts parsed:(void (^)(BOOL parsed, NSError *error))completion {
    NSArray *srtLines = [string componentsSeparatedByString:@"\n"];
